...
if (isset($_POST['submit'])) {
    ...
    //check and validate inpute values
    if (!$title) {
        ...
        if ($thumbnail['name']) {
            ...
            if (in_array($extension, $allowed_files)) {
                ...
                if ($thumbnail['size'] < 4000000) {
                    ...
                    $_SESSION['edit-post'] = "couldn't update post. thumbnail should be png, jpeg, or jpeh";
            }
        }
    }
    if ($_SESSION['edit-post']) {
        //redirect to manage form page if form was invaild
        ...
        //set thumbnail name if a new one was uploaded else keep ld thumbnail name 
